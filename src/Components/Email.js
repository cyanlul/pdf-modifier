    ...
    return (
        <div className="email-content">
            ...
            <div className="form-container">
                <form className="submit-form" method="post" enctype="multipart/form-data" onSubmit={sendEmail}>
                    <input
                    ...
                    <input className="form-field file-attach" type="file" name="editted_pdf" />
